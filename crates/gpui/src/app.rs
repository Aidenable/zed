...
pub struct App {
    ...
    pub(crate) reduce_animations: bool,
...
impl App {
    ...
    pub fn reduce_animations(&self) -> bool {
    ...
    pub fn set_reduce_animations(&mut self, reduce_animations: bool) {
        if self.reduce_animations != reduce_animations {
